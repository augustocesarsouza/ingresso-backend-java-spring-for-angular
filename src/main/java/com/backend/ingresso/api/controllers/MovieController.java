...
public class MovieController {
    ...
    @GetMapping("/public/movie/get-info-for-choose-movie-theater/{movieId}")
    public ResponseEntity<ResultService<MovieDTO>> getInfoForChooseMovie(@PathVariable String movieId){
        var result = movieService.getInfoForChooseMovie(movieId);
    ...
    @GetMapping("/public/movie/get-all-status-trending")
    public ResponseEntity<ResultService<List<MovieDTO>>> getAllStatusTrending(){
        var result = movieService.getAllStatusTrending();
    ...
    @GetMapping("/public/movie/get-status-highlight")
    public ResponseEntity<ResultService<MovieDTO>> getStatusHighlight(){
        var result = movieService.getStatusHighlight();
