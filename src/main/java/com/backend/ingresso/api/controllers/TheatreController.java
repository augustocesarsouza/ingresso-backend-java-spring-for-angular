...
//    let response = this._http.get(`/api/v1/public/theatre/get-all-theater-for-display-homepage`).pipe(take(1));
    ...
    @GetMapping("/public/theatre/get-all-theater-for-display-homepage")
    public ResponseEntity<ResultService<List<TheatreDTO>>> getAllTheaterForDisplayHomepage(){
        var result = theatreService.getAllTheaterForDisplayHomepage();
