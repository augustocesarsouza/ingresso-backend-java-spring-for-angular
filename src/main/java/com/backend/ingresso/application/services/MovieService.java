...
public class MovieService implements IMovieService {
    ...
    public ResultService<MovieDTO> getInfoForChooseMovie(String movieId) {
        ...
        try {
            Movie movie = movieRepository.getInfoForChooseMovie(UUID.fromString(movieId));
    ...
    public ResultService<List<MovieDTO>> getAllStatusTrending() {
        try {
            List<MovieDTO> movieDTOS = movieRepository.getAllStatusTrending();

            if(movieDTOS == null)
                return ResultService.Fail("error movie not exist");

            return ResultService.Ok(movieDTOS);
    ...
    public ResultService<MovieDTO> getStatusHighlight() {
        try {
            Movie movie = movieRepository.getStatusHighlight();
